...
// rotine-cart1
let pricezando3=21.95;
let Deliveryfee=1.25;
let Amountpay= pricezando3+Deliveryfee;
...
function add_to_cart(){
    ...
    quantity.image=img0.src;
    quantity.price=pricezando3;
  ...
  <div class="cart-item">
    <div class="cart-image">
      <img src="${quantity.image}" alt="Mesh Jersey T-Shirt">
    </div>
